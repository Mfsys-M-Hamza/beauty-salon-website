      ...
      <div className="overflow-hidden rounded-3xl border border-line bg-white shadow-soft">
        ...
        >
          <svg viewBox="0 0 400 208" className="size-full" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
            <rect width="400" height="208" fill="#f1ebdd" />
            <path d="M-10 150 C 90 120, 140 190, 260 140 S 380 90, 420 110" stroke="#e5dccb" strokeWidth="18" fill="none" />
            <path d="M120 -10 C 140 60, 110 120, 150 220" stroke="#e5dccb" strokeWidth="14" fill="none" />
            <path d="M-10 60 L 420 40" stroke="#e9e0cc" strokeWidth="8" fill="none" />
            <path d="M250 -10 L 300 220" stroke="#e9e0cc" strokeWidth="8" fill="none" />
            <rect x="170" y="70" width="60" height="40" rx="8" fill="#e6dcc4" />
            <rect x="300" y="120" width="70" height="50" rx="8" fill="#e6dcc4" />
            <rect x="30" y="90" width="60" height="45" rx="8" fill="#e6dcc4" />
            <circle cx="200" cy="100" r="14" fill="#7a5a14" className="pin-ring" style={{ transformBox: "fill-box", transformOrigin: "center" }} />
            <path d="M200 118c-9-11-14-18-14-26a14 14 0 0 1 28 0c0 8-5 15-14 26Z" fill="#7a5a14" />
            <circle cx="200" cy="92" r="5" fill="#faf7f0" />
          </svg>
        </a>
