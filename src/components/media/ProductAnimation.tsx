    ...
    >
      ...
      >
        ...
        <g>
          ...
          <path className="lip-bullet" d="M52 285V212L88 196V285Z" fill="#7a5a14" />
          <rect x="40" y="280" width="60" height="90" rx="8" fill="#141210" />
          <rect x="38" y="268" width="64" height="14" rx="4" fill="#85651c" />
          <rect x="46" y="238" width="48" height="30" fill="#d8b25e" />
          <g className="lip-cap">
            <rect x="42" y="190" width="56" height="80" rx="6" fill="#141210" />
            <rect x="42" y="250" width="56" height="8" fill="#d8b25e" />
        ...
        {products && (
          <>
            ...
            <g>
              ...
              <rect x="182" y="336" width="120" height="14" rx="7" fill="#ecdcb6" />
              <ellipse cx="242" cy="343" rx="46" ry="5" fill="#dcc79a" />
              <g className="compact-lid">
                <rect x="172" y="296" width="140" height="36" rx="12" fill="#d8b25e" />
                <rect x="182" y="304" width="120" height="20" rx="8" fill="#7a5a14" opacity="0.85" />
              </g>
            </g>
            ...
            <g>
              <g className="polish-cap">
                <rect x="394" y="214" width="30" height="72" rx="6" fill="#141210" />
                <rect x="406" y="286" width="6" height="52" rx="3" fill="#141210" />
              </g>
              <rect x="382" y="304" width="54" height="68" rx="12" fill="#5c430c" />
              <rect x="394" y="286" width="30" height="20" fill="#141210" />
